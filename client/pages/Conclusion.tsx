      ...
      <section className="py-12 md:py-16 border-b border-border">
        <div className="portfolio-container">
          ...
          <p className="text-lg text-foreground font-medium max-w-2xl">
            A summary of my journey, achievements, lessons learned, and honest
            reflection on where I stand and where I'm headed.
          </p>
        </div>
      </section>
      ...
      <section className="section-padding border-b border-border">
        <div className="portfolio-container">
          ...
          <p className="section-subtitle">
            Key milestones and accomplishments across my academic and
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-foreground font-medium">
                    Maintained CGPA of 9.91/10.00 throughout B.Tech program at
                ...
                <li className="flex items-start gap-3">
                  <span className="text-primary font-bold text-lg">★</span>
                  <span className="text-foreground font-medium">
                    Strong foundation in Data Structures, Algorithms, Database
                ...
                <li className="flex items-start gap-3">
                  <span className="text-primary font-bold text-lg">★</span>
                  <span className="text-foreground font-medium">
                    Demonstrated consistent learning mindset and mastery across
            ...
            <div className="folded-note p-8 fold-shadow-2 paper-corner paper-texture">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-foreground font-medium">
                    Won JPMC Code for Good 2025, selected among top 400 of
                    60,000+ participants
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent font-bold text-lg">🏆</span>
                  <span className="text-foreground font-medium">
                    Reached top 300 in Odoo India Hackathon 2025 out of 6,000+
                    teams
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent font-bold text-lg">🏆</span>
                  <span className="text-foreground font-medium">
                    IOQM (Indian Olympiad Qualifier in Mathematics) Qualifier –
                    2 consecutive years
                  </span>
                </li>
              </ul>
            ...
            <div className="folded-note p-8 fold-shadow-2 paper-corner paper-texture">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-foreground font-medium">
                    Built multiple full-stack applications (Flask, React,
                    Next.js)
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold text-lg">✓</span>
                  <span className="text-foreground font-medium">
                    Hands-on experience with database design, API development,
                ...
                <li className="flex items-start gap-3">
                  <span className="text-secondary font-bold text-lg">✓</span>
                  <span className="text-foreground font-medium">
                    Integrated advanced technologies: AI chatbots, multilingual
            ...
            <div className="folded-note p-8 fold-shadow-2 paper-corner paper-texture">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-foreground font-medium">
                    Demonstrated teamwork, leadership, and collaboration in
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-foreground font-medium">
                    Ethical mindset; active advocate for responsible technology
                    development
                  </span>
                </li>
              </ul>
            ...
            <div className="folded-note p-8 fold-shadow-2 paper-corner paper-texture border-l-4 border-orange-400">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-orange-400 font-bold">-</span>
                  <span className="text-foreground font-medium">
                    Perfectionism can sometimes slow down decision-making and
                    shipping
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-400 font-bold">-</span>
                  <span className="text-foreground font-medium">
                    Limited experience with large-scale distributed systems in
                    production
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-400 font-bold">-</span>
                  <span className="text-foreground font-medium">
                    Could strengthen skills in specific domains (ML, advanced
                    DevOps)
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-400 font-bold">-</span>
                  <span className="text-foreground font-medium">
                    Limited mentorship from senior engineers in a professional
                    setting
                  </span>
                </li>
              </ul>
            ...
            <div className="folded-note p-8 fold-shadow-2 paper-corner paper-texture border-l-4 border-green-500">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-foreground font-medium">
                    High demand for software engineers; strong market for data
                    engineering roles
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-green-500 font-bold">◆</span>
                  <span className="text-foreground font-medium">
                    Growing focus on ethical AI and responsible tech creates
                    opportunities
                  </span>
                </li>
                <li className="flex items-start gap-3">
            ...
            <div className="folded-note p-8 fold-shadow-2 paper-corner paper-texture border-l-4 border-red-500">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-foreground font-medium">
                    Competitive job market; many talented engineers seeking
                    roles
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-red-500 font-bold">△</span>
                  <span className="text-foreground font-medium">
                    Rapid tech change requires constant upskilling to stay
                    relevant
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-red-500 font-bold">△</span>
                  <span className="text-foreground font-medium">
                    Economic downturns can impact hiring and growth
                    opportunities
                  </span>
                </li>
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-red-500 font-bold">△</span>
                  <span className="text-foreground font-medium">
                    Pressure to prioritize short-term gains over long-term
                    learning
                  </span>
                </li>
              </ul>
        ...
        <div className="portfolio-container">
          <div className="letter-container">
            ...
            <div className="relative z-10 space-y-4 text-foreground leading-relaxed font-medium">
              <p>
                Standing at the threshold of my career, I'm grateful for the
                journey that brought me here. My path has been marked by strong
                academic performance, competitive achievements, and hands-on
                experience solving real problems. But beyond metrics and
                accomplishments, I've developed a philosophy about technology
                and professional growth.
              </p>

              <p>
                I've learned that technical excellence is necessary but
                insufficient. How we build, what we build, and whom we serve
                matter as much as the elegance of our code. I'm committed to
                being an engineer who solves hard problems with integrity, who
                mentors others, and who advocates for responsible technology
                development.
              </p>

              <p>
                Looking ahead, I'm excited and humbled. Excited by the technical
                challenges I'll tackle, the projects I'll build, and the impact
                I hope to create. Humbled by how much I still have to learn and
                the responsibility that comes with building systems others
                depend on.
              </p>

              <p>
                My next chapter will be written through deliberate action,
                continuous learning, and unwavering commitment to my values. I'm
                ready to contribute meaningfully to teams and organizations that
                share my vision of building technology that matters.
              </p>

              <p className="pt-4 italic text-sm">— Shlok Patel, June 2025</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 bg-background border-b border-border">
        <div className="portfolio-container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <Link to="/testimonials" className="paper-button">
              View Testimonials
